...
function theme() {
    ...
    const btnContainer3 = document.getElementById('btn-container-3')

    main.classList.toggle("black-theme");
    btnContainer1.classList.toggle("black-btn")
    btnContainer2.classList.toggle("black-btn")
    btnContainer3.classList.toggle("black-btn")
